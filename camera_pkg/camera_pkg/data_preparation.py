...
actions = np.array(['Good Job','Hello', 'Fist Bump','High Five', 'Hungry', 'Thirsty'])#'Good Job', 'Hello', 'Fist Bump', 'Congrats', "What's up", "I'm Fine", 'Take Care'])  # Actions that we try to detect
