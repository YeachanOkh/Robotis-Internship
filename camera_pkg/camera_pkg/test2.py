...
class CameraNode(Node):
    ...
    def listener_callback(self, msg):
        self.get_logger().info(f'Received gesture done confirmation: {msg.data}')
        self.gesture_in_progress = False
    ...
    def publish_feedback(self, feedback):
        ...
        self.get_logger().info(f'Gesture published: {msg.data}')
                        ...
                        if detecting_gesture:
                            if gesture_start_time is None:
                                ...
                                if len(sequence) == 30:
                                    ...
                                    if np.max(res) > threshold:
                                        ...
                                        last_predicted_gesture = actions[np.argmax(res)]
                                        self.gesture_in_progress = True
                                        self.publish_feedback(last_predicted_gesture)
                            ...
                            if rest_start_time is None:
                                ...
                                if last_predicted_gesture:
                                    cv2.putText(image, f'Last Gesture: {last_predicted_gesture}',
