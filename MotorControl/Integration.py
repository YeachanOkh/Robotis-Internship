...
if __name__ == "__main__":
    ...
    # motor.simMotorRun([90,270,45,265,180], [0,1,2,3,4])  # ALWAYS SET SPEED BEFORE ANYTHING
    # time.sleep(2)  
    motor.simMotorRun([130,270,130,150], [4,1,3,2])  # ALWAYS SET SPEED BEFORE ANYTHING
